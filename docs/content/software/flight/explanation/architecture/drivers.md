...
Catalog of mission device drivers. For how PEROVSAT drivers are structured, see [Driver Model](../driver-model.md). For Zephyr driver basics, see [Zephyr Drivers](../zephyr/drivers.md).
...
The driver depends on Aerospace's [AMULIB](https://github.com/the-aerospace-corporation/amulib/tree/main) for hardware interaction.
