# DBuild How-to Guides

Recipes for working with the DBuild device configuration system.

## Guides

- [Add a device to DBuild](add-device.md) — register a new logical device, snippets, and west projects
